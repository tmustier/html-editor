...
TABLE_ACTIONS_NEED_SOURCE = _table_ops.TABLE_ACTIONS_NEED_SOURCE
...
def table_operation(
    ...
    *,
    ...
    return _table_ops.table_operation(
        soup,
        cell_id,
        action,
        find_by_edit_id=find_by_edit_id,
        assign_missing_edit_ids=assign_missing_edit_ids,
